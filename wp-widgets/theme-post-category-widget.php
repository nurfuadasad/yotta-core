...
class Yotta_Category_Widget extends WP_Widget {

    public function __construct() {
        parent::__construct(
            'yotta_category',
            esc_html__( 'Yotta:  Category', 'yotta-core' ),
    ...
    public function widget( $args, $instance ) {
        ...
        if ( ! empty( $all_terms ) ):?>
            ...
            esc_html__( ' Oops, there are no category.', 'yotta-core' )
            ?>
        <?php endif; ?>
        </ul>
        <?php
    ...
    public function form( $instance ) {
        ...
        if (!empty($instance) && $instance['title']) {
            ...
            $title = esc_html__('Category', 'yotta-core');
        ...
        $taxonomy = array(
            'category' => esc_html__('Blog Category', 'yotta-core'),
            'packages-cat' => esc_html__('Packages Category', 'yotta-core'),
            'training-cat' => esc_html__('training Category', 'yotta-core'),
            'course-category' => esc_html__('Courses Category', 'yotta-core'),
            'service-cat' => esc_html__('Service Category', 'yotta-core')
        );
        $order_arr   = array(
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('taxonomy')) ?>"><?php esc_html_e('Taxonomy', 'yotta-core'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')) ?>"><?php esc_html_e('Number', 'yotta-core'); ?></label>
...
if ( ! function_exists( 'Yotta_Category_Widget' ) ) {
    function Yotta_Category_Widget() {
        register_widget( 'Yotta_Category_Widget' );
    }

    add_action( 'widgets_init', 'Yotta_Category_Widget' );
}
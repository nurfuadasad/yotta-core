...
namespace Elementor;
class Yotta_Blockqute_Two_Item_Widget extends Widget_Base
{
    ...
    {
        return 'yotta-blockquote-two-widget';
    }
    ...
    {
        return esc_html__('Blockquote: 02', 'yotta-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .element-blockquote' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control('content_bg_color', [
            ...
            'selectors' => [
                "{{WRAPPER}} .element-blockquote" => "background-color: {{VALUE}}"
            ]
        ]);
        $this->add_control('content_border_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .element-blockquote::before" => "background-color: {{VALUE}}"
            ]
        ]);
        $this->add_control('icon_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .element-blockquote .quote-icon" => "color: {{VALUE}}"
            ]
        ]);
        $this->add_control('title_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .element-blockquote .quote-content" => "color: {{VALUE}}"
            ]
        ]);
        $this->add_control('author_typography', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .element-blockquote .quote-content-area span" => "color: {{VALUE}}"
            ]
        ]);
...
Plugin::instance()->widgets_manager->register_widget_type(new Yotta_Blockqute_Two_Item_Widget());
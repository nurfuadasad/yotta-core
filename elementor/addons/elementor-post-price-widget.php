...
namespace Elementor;
class Yotta_Post_Price extends Widget_Base {

    public function get_name() {
        return 'power_site_builder_post_price';
    }

    public function get_title() {
        return esc_html__( 'Post Price', 'yotta-core' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'psb_section_post_price_section',
            [
                'label' => esc_html__( 'Post Price', 'yotta-core' ),
            ]
        );
        $this->add_control(
    ...
    protected function render() {
        ...
        $packages_single_meta_data = get_post_meta(get_the_ID(), 'yotta_training_options', true);
        extract($settings);
        $post_title = $psb_post_title_use_custom_title == 'yes' ? $psb_post_title_custom_title : $packages_single_meta_data['training_price_option'];
...
Plugin::instance()->widgets_manager->register_widget_type(new Yotta_Post_Price());
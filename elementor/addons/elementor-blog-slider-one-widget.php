...
namespace Elementor;
class Yotta_Blog_Post_Slider_One_Widget extends Widget_Base
{
...
Plugin::instance()->widgets_manager->register_widget_type(new Yotta_Blog_Post_Slider_One_Widget());
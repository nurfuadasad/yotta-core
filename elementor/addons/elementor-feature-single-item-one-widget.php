...
namespace Elementor;
class Yotta_Feature_Single_Item_Widget extends Widget_Base
{
    ...
    {
        return 'yotta-feature-single-item-widget';
    }
    ...
    {
        return esc_html__('Feature Single Item', 'yotta-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'box_icon_settings_section',
            [
                'label' => esc_html__('Box Icon Style', 'yotta-core'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Icon Background Image', 'yotta-core'),
                'types' => ['classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .feature-section--style .feature-item .feature-icon-area::before',
            ]
        );
        $this->add_control(
            'icon',
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .feature-section--style .feature-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .feature-section--style .feature-item',
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .feature-section--style .feature-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control('normal_number_color', [
            ...
            'condition' => array('number_switch' => 'yes'),
            'selectors' => [
                "{{WRAPPER}} .feature-section--style .feature-item .feature-content .title span" => "color: {{VALUE}};"
            ]
        ]);
    ...
    protected function render()
    {
        ...
        <div class="feature-section--style">
            <div class="feature-item" style="text-align:<?php echo $settings['text_align']; ?>">
...
Plugin::instance()->widgets_manager->register_widget_type(new Yotta_Feature_Single_Item_Widget());
...
class Yotta_Testimonial_Two_Widget extends Widget_Base
{
    ...
    {
        return 'yotta-testimonial-two-widget';
    }
    ...
    {
        return esc_html__('Yotta: Testimonial 2', 'yotta-core');
    }
    /**
     * Get widget keyword.
     *
    ...
    protected function register_controls()
    {
        ...
        [
            ...
            'description' => esc_html__('Enter Testimonial Title', 'yotta-core'),
            'default' => esc_html__('WordPress Hosting', 'yotta-core')
        ]);
...
Fight School has specialized.", 'yotta-core'),
    ...
    protected function render()
    {
        ...
        <div class="client-slider-area two">
            ...
            <div class="client-slider-two yottaTestimonialTwo" id="yotta-testimonialTwo-<?php echo esc_attr($rand_numb); ?>"
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="client-item two">
                            <div class="client-header two">

                                <?php if ($item['icon_status'] == 'yes'): ?>
                                <div class="client-header-user-thumb">
                                <?php
                                    if (!empty($item['icon'])){
                                ...
                                <div class="client-header-user-content">
                                    <h4 class="title"><?php echo esc_html($item['testimonial_title']); ?></h4>
                                </div>
                                <?php endif; ?>
                            </div>
                            <!-- Description -->
                            ...
                            <div class="client-footer two">
                                ...
                                <?php if($item['client_name']): ?>
                                    <h4 class="title"><?php echo esc_html($item['client_name']); ?></h4>
                                <?php endif; ?>
                                <?php if($item['designation_status'] === 'yes'): ?>
                                    <span class="sub-title"><?php echo esc_html($item['designation']); ?></span>
                                <?php endif; ?>
                                </div>
...
Plugin::instance()->widgets_manager->register_widget_type(new Yotta_Testimonial_Two_Widget());

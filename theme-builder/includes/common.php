...
class Common{
    ...
    public $posttype = 'themeim-builder';
    ...
    public function template_type_array( $index = ''){
        $type = apply_filters('yotta_head_template_type', [
    ...
    public function working_posttype(){
        ...
        return apply_filters('yotta_head_template_select_posttype', array_values($post_types) );
    }
